...
?- solucion(L).
L = [
    investigador(ana, inmunologia, 12, te, pcr, peru),
    investigador(bruno, neurociencia, 14, jugo, incubadora, espana),
    investigador(carlos, genetica, 6, agua, espectrometro, mexico),
    investigador(diana, microbiologia, 8, cafe, microscopio, chile),
    investigador(elisa, bioquimica, 10, mate, centrifuga, argentina)
]